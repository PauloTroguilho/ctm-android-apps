...
public interface ServicoIntercomunicacao21 {
    ...
    @RequestWrapper(localName = "consultarAlteracao", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoConsultarAlteracao")
    @ResponseWrapper(localName = "consultarAlteracaoResposta", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoConsultarAlteracaoResposta")
    ...
    @RequestWrapper(localName = "consultarAvisosPendentes", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoConsultarAvisosPendentes")
    @ResponseWrapper(localName = "consultarAvisosPendentesResposta", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoConsultarAvisosPendentesResposta")
    ...
    @RequestWrapper(localName = "consultarProcesso", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoConsultarProcesso")
    @ResponseWrapper(localName = "consultarProcessoResposta", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoConsultarProcessoResposta")
    ...
    @RequestWrapper(localName = "consultarTeorComunicacao", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoConsultarTeorComunicacaoResposta")
    @ResponseWrapper(localName = "consultarTeorComunicacaoResposta", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoConsultarTeorComunicacaoResposta")
    ...
    @RequestWrapper(localName = "entregarManifestacaoProcessual", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoEntregarManifestacaoProcessual")
    @ResponseWrapper(localName = "entregarManifestacaoProcessualResposta", targetNamespace = "http://www.cnj.jus.br/servico-intercomunicacao-2.1/", className = "br.jus.cnj.pje.TipoEntregarManifestacaoProcessualResposta")
