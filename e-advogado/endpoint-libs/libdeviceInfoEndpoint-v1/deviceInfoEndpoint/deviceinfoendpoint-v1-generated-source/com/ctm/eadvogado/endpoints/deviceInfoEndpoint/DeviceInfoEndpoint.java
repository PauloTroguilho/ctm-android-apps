 ...
 * on 2013-07-22 at 03:53:35 UTC 
 * Modify at your own risk.
 */

package com.ctm.eadvogado.endpoints.deviceInfoEndpoint;
...
public class DeviceInfoEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetByID extends DeviceInfoEndpointRequest<com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo> {
    ...
    protected GetByID(java.lang.Long id) {
      super(DeviceInfoEndpoint.this, "GET", REST_PATH, null, com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo.class);
   ...
   *
   * @param content the {@link com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo}
   * @return the request
   */
  public Insert insert(com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends DeviceInfoEndpointRequest<com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected Insert(com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo content) {
      super(DeviceInfoEndpoint.this, "POST", REST_PATH, content, com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo.class);
    }
  ...
  public class ListAll extends DeviceInfoEndpointRequest<com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.CollectionResponseDeviceInfo> {
     ...
     */
    protected ListAll() {
      super(DeviceInfoEndpoint.this, "GET", REST_PATH, null, com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.CollectionResponseDeviceInfo.class);
    }
  ...
  public class Remove extends DeviceInfoEndpointRequest<com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo> {
    ...
    protected Remove(java.lang.Long id) {
      super(DeviceInfoEndpoint.this, "DELETE", REST_PATH, null, com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo content) throws java.io.IOException {
    Update result = new Update(content);
    initialize(result);
    return result;
  }

  public class Update extends DeviceInfoEndpointRequest<com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected Update(com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo content) {
      super(DeviceInfoEndpoint.this, "PUT", REST_PATH, content, com.ctm.eadvogado.endpoints.deviceInfoEndpoint.model.DeviceInfo.class);
    }
