 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "ctm.com", ownerName = "ctm.com", packagePath="eadvogado"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyCS1MttbIwXD5Zh7Dn6AMYI0zQdUo_RYmU";
